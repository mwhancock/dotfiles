...
local toggle_explorer = function(path)
...
local explore_at_file = function()
  toggle_explorer(vim.api.nvim_buf_get_name(0))
end
...
nmap_leader('ed', toggle_explorer,                          'Directory')
...
nmap_leader('sv', '<Cmd>vsplit<CR>',                              'Split Window Vertically')
nmap_leader('sh', '<Cmd>split<CR>',                               'Split Window Horizontally')
nmap_leader('se', '<C-w>=',                                       'Make Splits Equal Size')
