...
--
-- Autocomplete and command-line suggestion helpers are intentionally disabled in
-- this config to keep editing distraction-free.
...
now_if_args(function()
  ...
  end, 'Polish mini.files mappings')
...
-- Show focused key clues in a small which-key-like window. Requires explicit
-- opt-in for keys that act as clue trigger. Example usage:
-- - Press `<Leader>` and wait briefly. A window with information about
